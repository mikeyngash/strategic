#!/bin/bash
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# System Request : Debian 9+/Ubuntu 18.04+/20+/22.04+/23.04+/23.10+/24.04+
# Develovers » Alby
# Email      » albytechy@gmail.com
# telegram   » https://t.me/Marcus_alby
# whatsapp   » wa.me/+254704838989
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# ALby script
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "  Script : ${GRAY} 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐀𝐋𝐁𝐘 𝐒𝐓𝐎𝐑𝐄 ${NC}"
echo -e "  Author : ${RED}𝐋𝐎𝐑𝐃 𝐀𝐋𝐁𝐘 ${NC}${YELLOW}${NC}"
echo -e "  ©2025  : ${BLUE} 𝐒𝐓𝐀𝐁𝐋𝐄 𝐄𝐃𝐈𝐓𝐈𝐎𝐍 ${NC}"
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/mikeyngash/strategic/main/"
...
function first_setup(){
    ...
    if [[ $(cat /etc/os-release | grep -w ID | head -n1 | sed 's/=//g' | sed 's/"//g' | sed 's/ID//g') == "ubuntu" ]]; then
        ...
        # Install HAProxy based on Ubuntu version
        if [[ $(echo "$ubuntu_version >= 22.04" | bc) -eq 1 ]]; then
            # For Ubuntu 22.04 and newer, use the default HAProxy from repositories
            apt-get -y install haproxy
        else
            # For older Ubuntu versions, use the PPA
...
function base_package() {
    ...
    # Check if chronyd exists, if not use chrony
...
function password_default() {
    ...
    CHATID="8386471972"
    KEY="8221807960:AAHIgKYG80CcEGVJS7ZDB2NVh0yL03qzwBQ"
    TIME="10"
    URL="https://api.telegram.org/bot$KEY/sendMessage"
    TEXT="
<code>━━━━━━━━━━━━━━━━━━━━━━━━━</code>
<b>SCRIPT INSTALLED SUCCESSFULLY</b>
<code>━━━━━━━━━━━━━━━━━━━━━━━━━</code>
...
<code>━━━━━━━━━━━━━━━━━━━━━━━━━</code>
<i>Don't forget to renew cert</i>
"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/mikeyngash/strategic/main/keygen"
# USERNAME
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/+254704838989"}]]}' 
